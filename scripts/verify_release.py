...
EXPECTED="0.2.2"
EXPECTED_TOOLS={
 "nerve_decide","nerve_rank","nerve_verify","nerve_assess","nerve_context_curate","nerve_context_rehydrate","nerve_stats","nerve_event",
...
def main():
 ...
 with tempfile.TemporaryDirectory() as t:
  ...
  # Ordinary Kanban workers must expose zero Nerve schemas while retaining the
