...
| Unrecoverable evidence consumes provider capacity | Semantic assessment ran before deterministic `KEEP_EXACT` policy | Automatic engine selection excludes unrecoverable evidence from remote curation |
