...
For Hermes-Jev development, only that repository's README and repository layout were inspected through GitHub. Its implementation files were not fetched into the working tree or copied.
...
- lifecycle leases tied to `jev_verify`,
