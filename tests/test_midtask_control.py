...
class MidTaskControlTests(unittest.TestCase):
    ...
    def test_advisory_replan_blocks_new_work_until_checkpoint(self):
        ...
        env={"HERMES_KANBAN_TASK_ID":"t","HERMES_KANBAN_RUN_ID":"1","HERMES_NERVE_DOD_HASH":ident.contract_hash,"HERMES_KANBAN_CLAIM_IDENTITY":"claim","HERMES_KANBAN_WORKER_ID":"worker"}
    ...
    def test_remote_checkpoint_requests_exact_run_review_and_stop(self):
        ...
        bridge.consume({"type":"tool_use","name":"nerve_work_event","input":{"event_type":"CHECKPOINT_READY","task_id":"t","run_id":1,"contract_hash":ident.contract_hash,"claim_identity":"claim","payload":{"reason":"bad trajectory","current_plan":"saved"}}})
    ...
    def test_stale_remote_event_is_rejected(self):
        ...
        bridge.consume({"type":"tool_use","name":"nerve_work_event","input":{"event_type":"PLAN_CHANGED","task_id":"t","run_id":999,"contract_hash":ident.contract_hash,"payload":{}}})
